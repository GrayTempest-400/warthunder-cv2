...
本项目大体已完成，就剩下唯一一个问题，有能力的佬可以帮忙给出建议,问题描述如下：
![testdetect](https://github.com/GrayTempest-400/warthunder-cv2/assets/101955396/0ce59e58-91d5-4ca9-a3b5-48c7add46500)
蓝色点是PXPY屏幕坐标转换出来的点，位置也正常,但鼠标移动会抽风，无法正确拉到点上
