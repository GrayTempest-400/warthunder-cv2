...
1，运行完run.py和runf.py后cmd在正样本和负样本中cmd 分别输入dir /b/s/p/w *.jpg > have_thank.txt 创建路径文件
...
6,cmd继续运行.\opencv_traincascade.exe  -data xml -vec havethank.vec -bg have_thank.txt-numPos 1500 -numNeg 1169 -numStages 20 -featureType HAAR -w 20 -h 20
